...
namespace MangageCoffee.UICoffee.ManageDishes
{
    public partial class ManageDishes_edit : Form
    {
        ...
        private void save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (isEdit)
                {
                    ...
                    tempProduct.Category = TxtType.SelectedItem?.ToString();
                    tempProduct.Status = TxtStatus.SelectedItem?.ToString();
                    tempProduct.OriginalPrice = double.Parse(TxtId.Text);
                    tempProduct.ImagePath = _newImagePath ?? tempProduct.ImagePath; // Keep old path if no new image
                ...
                else
                {
                    ...
                    newProduct.Category = TxtType.SelectedItem?.ToString();
        ...
        private string _newImagePath = null;// To store the full path of the selected image
