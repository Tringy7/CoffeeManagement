...
namespace MangageCoffee.BL
{
    public class BL_Product
    {
        ...
        {
            string sqlString = "INSERT INTO Products (Name, Price, Quantity, Category, Status, CreatedBy) " +
                      "VALUES (@Name, @Price, @Quantity, @Category, @Status, @CreatedBy)";
        ...
        public bool updateProduct(Class_product product, ref string error)
        {
            string sqlString = "UPDATE Products SET Name = @Name, Price = @Price, Quantity = @Quantity, " +
                               "Category = @Category, Status = @Status, CreatedBy = @CreatedBy " +
